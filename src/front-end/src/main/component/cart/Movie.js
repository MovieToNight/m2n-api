...
class Movie extends Component {
    ...
    render() {
        ...
        href = "/" >
            { < img
        src = {require("./M2N-logos_black.png"
    )
    }
        alt = "logo"
        width = "100"
    ...
    <
        ...
        Nolan < /MenuItem>
        < MenuItem
        value = {7} > Space < /MenuItem>
            < MenuItem
        value = {8} > Parallel
        Unniverse < /MenuItem>
        < MenuItem
        value = {9} > Mystery < /MenuItem>
            < MenuItem
        value = {10} > Deja
        Vu < /MenuItem>
        < MenuItem
        value = {11} > Psychological
        Thrillers < /MenuItem>
        < MenuItem
        value = {12} > Sci - Fi < /MenuItem>
